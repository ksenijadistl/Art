	...
	<div id="headerSlider" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
		  <div class="carousel-item active ">
			<img src="img/first.jpg" class="d-block img-fluid" alt="first"  style="width:100%;height:500px;">
			<div class="carousel-caption " >
				<img src="img/mdlogo1.png"  alt="logo" >
				</div>
		  </div>
		  <div class="carousel-item">
			<img src="img/art.jpg" class="d-block img-fluid" alt="art"  style="width:100%;height:500px;">
		    <div class="carousel-caption">
				<a href="art.php"> <img src="img/artLogo.png"  alt="artLogo" style="margin-left: 500px;"></a>
				
			</div>
	      </div>
		  <div class="carousel-item">
			<img src="img/draw.jpg" class="d-block img-fluid" alt="draw"  style="width:100%;height:500px;">
			<div class="carousel-caption">
				<a href="draw.php"><img src="img/drawLogo.png"  alt="drawLogo" ></a>
				
			</div>
		  </div>
		  <div class="carousel-item">
			<img src="img/sculpture.jpg" class="d-block img-fluid" alt="sculpture" style="width:100%;height:650px;">
			<div class="carousel-caption">
				<a href="sculpture.php"><img src="img/sculptureLogo.png"  alt="sculptureLogo" style="margin-right: 500px;" ></a>
				
			</div>
		  </div>
		  <div class="carousel-item">
			<img src="img/youcreate.jpg" class="d-block img-fluid" alt="create"  style="width:100%;height:500px;">
			<div class="carousel-caption">
				<a href="create.php"><img src="img/createLogo.png"  alt="createLogo" ></a>
...
<section id="about" style="height: 800px;">
	<div class="container" >
		<div class="row" >
			<div class="col-md-6" >
				<img src="img/Maja.jpg" alt="Maja" style="width:200px;height:250px;margin-top: 70px;">
				<h2 style="margin-top: 70px;">Maja Distl</h2>
				<h5 style="margin-left: 40%;float: left;">Umetnica</h5>  
