...
<head>
	...
	<link rel="stylesheet" href="scss/art.css">
...
<body>
	...
	<section id="nav-bar">
		<nav class="navbar navbar-expand-lg navbar-light ">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="create.php">Poruči</a>
				  </li>
	...
	<section id="card">
		...
		<hr>
		<div class="card" >
			<img src="img/crtez (1).jpg" class="card-img-top" alt="...">
			<div class="card-body">
		  ...
		  <div class="card" >
			<img src="img/crtez (2).jpg" class="card-img-top" alt="...">
			<div class="card-body">
		  ...
		  <div class="card" >
			<img src="img/crtez (3).jpg" class="card-img-top" alt="...">
			<div class="card-body">
		  ...
		  <div class="card">
			<img src="img/crtez (4).jpg" class="card-img-top" alt="...">
			<div class="card-body">
		  ...
		  <div class="card" >
			<img src="img/crtez (5).jpg" class="card-img-top" alt="...">
			<div class="card-body">
		  ...
		  <div class="card" >
			<img src="img/crtez (6).jpg" class="card-img-top" alt="...">
			<div class="card-body">
		  ...
		  <div class="card" >
			<img src="img/crtez (7).jpg" class="card-img-top" alt="...">
			<div class="card-body">
