...
<body>
	...
	<section id="card">
		...
		<h1 style="text-align: center;">Skulpture</h1>
		<hr>
		<div class="card" >
			<img src="img/sculpture (1).jpg" class="card-img-top" alt="...">
			<div class="card-body">
			  <h5 class="card-title">ZMAJ</h5>
			  <p class="card-text">Skulptura od gipsa</p>
			  <a href="#" class="btn btn-danger">Kupi</a>
			</div>
		  </div>
		  <div class="card" >
			<img src="img/sculpture (2).jpg" class="card-img-top" alt="...">
			<div class="card-body">
				<h5 class="card-title">BISTA</h5>
				<p class="card-text">Skulptura od gipsa</p>
			  <a href="#" class="btn btn-danger">Kupi</a>
			</div>
		  </div>
		  <div class="card" >
			<img src="img/sculpture (3).jpg" class="card-img-top" alt="...">
			<div class="card-body">
				<h5 class="card-title">ŠKOLJKA</h5>
			  <p class="card-text">Skulptura od gipsa</p>
		  ...
		  <div class="card">
			<img src="img/sculpture (4).jpg" class="card-img-top" alt="...">
			<div class="card-body">
				<h5 class="card-title">RELJEFNA SKULPTURA</h5>
				<p class="card-text">Skulptura od gipsa</p>
			  <a href="#" class="btn btn-danger">Kupi</a>
			</div>
		  </div>
